...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form class="d-inline-block float-right my-4" method="POST" action="{{ route('laporan.approve', $laporan->id_laporan_masalah) }}">
            @csrf
        ...
        @else
            ...
            <form action="{{ route('laporan.feedback.store', $laporan->id_laporan_masalah) }}" method="POST" enctype="multipart/form-data">
                @csrf
