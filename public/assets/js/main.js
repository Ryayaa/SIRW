...
// For Berita dan Kegiatan
document.addEventListener("DOMContentLoaded", function() {
    var judulElements = document.querySelectorAll(".article-list h1");

    judulElements.forEach(function(element) {
        if (element.textContent.length > 90) {
            element.textContent = element.textContent.slice(0, 90) + "...";
        }
    });
});
document.addEventListener("DOMContentLoaded", function() {
    var paragrafElements = document.querySelectorAll(".article-list p");

    paragrafElements.forEach(function(element) {
        if (element.textContent.length > 90) {
            element.textContent = element.textContent.slice(0, 90) + "...";
        }
    });
...
document.addEventListener("DOMContentLoaded", function() {
    var paragrafElements = document.querySelectorAll(".umkm-alamat");
